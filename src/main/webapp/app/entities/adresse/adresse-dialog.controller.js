(function() {
    ...
    AdresseDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Adresse', 'Personne'];

    function AdresseDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Adresse, Personne) {
        var vm = this;
